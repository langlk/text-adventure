...
export const PAGES: Page[] = [
  ...
  new Page(
    "I think you've made a mistake. You do realize what the fate of an ORDINARY CITIZEN is likely to be in a SUPERHERO COMIC, yes? It's NOT GOOD. You really ought to choose someone PLOT-CRITICAL.",
    [
      new Option("Go to second page", 2, -1),
      new Option("Go to first Page", 1, -2)
    ],
